...
clamp-cli_preempt: obj/clamp-cli_preempt.o obj/model_library.o obj/rt_thread_functions.o obj/writer_thread_functions.o obj/comedi_functions.o obj/calibrate_functions_phase1.o obj/calibrate_functions_phase2.o obj/time_functions.o obj/queue_functions.o
	$(CC) $(CCFLAGS) -o clamp-cli_preempt obj/clamp-cli_preempt.o obj/model_library.o obj/rt_thread_functions.o obj/writer_thread_functions.o obj/comedi_functions.o obj/calibrate_functions_phase1.o obj/calibrate_functions_phase2.o obj/time_functions.o obj/queue_functions.o $(LIBS_COMEDI) $(LIBS_RT)
